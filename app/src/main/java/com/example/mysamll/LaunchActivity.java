    ...
    public void clickHome(View v){
        Small.setUp(this, new net.wequick.small.Small.OnCompleteListener() {
            ...
            public void onComplete() {
                Small.openUri("home", LaunchActivity.this);
            }
        });
...
//        Small.openUri("detail",LaunchActivity.this);
    ...
    public void clickTest(View v){
        Small.setUp(this, new net.wequick.small.Small.OnCompleteListener() {
            @Override
            public void onComplete() {
                Small.openUri("test", LaunchActivity.this);//启动默认的Activity，参考wiki中的UI route启动其他Activity
            }
        });
//        Small.openUri("detail",LaunchActivity.this);
        Toast.makeText(LaunchActivity.this, "had press", Toast.LENGTH_SHORT).show();
    ...
    public void clickTest2(View v){
        Small.setUp(this, new net.wequick.small.Small.OnCompleteListener() {
            @Override
            public void onComplete() {
                Small.openUri("testtwo", LaunchActivity.this);//启动默认的Activity，参考wiki中的UI route启动其他Activity
            }
        });
//        Small.openUri("detail",LaunchActivity.this);
        Toast.makeText(LaunchActivity.this, "had press", Toast.LENGTH_SHORT).show();
